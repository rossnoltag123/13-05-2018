...
public class GameManagerScript : MonoBehaviour
{
    ...
    public void ProgramWalk(ProgramModel.ProgramInstructions instruction){
        programManager.programController.AddInstructionToList(instruction);
    }
    ...
    public void ProgramJump(ProgramModel.ProgramInstructions instruction){
        programManager.programController.AddInstructionToList(instruction);
    }
    ...
    public void LightSquareButton(){
        ...
        if (programModeActivated){
            ProgramLigthSquare(ProgramModel.ProgramInstructions.LIGHTUP);
        }
        programModeInstructions.text = programManager.programModel.GetProgramInstructions(ProgramModel.ProgramInstructions.LIGHTUP);
    }
    ...
    public void WalkNorthButton(){
        ...
        if (programModeActivated){
            ProgramWalk(ProgramModel.ProgramInstructions.WALK_NORTH);
        }
    ...
    public void WalkSouthButton(){
        ...
        if (programModeActivated){
            ProgramWalk(ProgramModel.ProgramInstructions.WALK_SOUTH);
        }
    ...
    public void WalkEastButton(){
        ...
        if (programModeActivated){
            ProgramWalk(ProgramModel.ProgramInstructions.WALK_EAST);
        }
    ...
    public void WalkWestButton(){
        ...
        if (programModeActivated){
            ProgramWalk(ProgramModel.ProgramInstructions.WALK_WEST);
        }
    ...
    public void JumpNorthButton(){
        ...
        if (programModeActivated){
            ProgramJump(ProgramModel.ProgramInstructions.JUMP_NORTH);
        }
    ...
    public void JumpSouthButton(){
        ...
        if (programModeActivated){
            ProgramJump(ProgramModel.ProgramInstructions.JUMP_SOUTH);
        }
    ...
    public void JumpEastButton(){
        ...
        if (programModeActivated){
            ProgramJump(ProgramModel.ProgramInstructions.JUMP_EAST);
        }
    ...
    public void JumpWestButton(){
        ...
        if (programModeActivated){
            ProgramJump(ProgramModel.ProgramInstructions.JUMP_WEST);
        }
